...
def scrape_news():
    ...
    with client as db:
        ...
        us_paper = newspaper.build('https://cnn.com', memoize_articles=False, fetch_images=False)
        ...
        #print("Size of EU paper: " + eu_paper.size())
        #print("Size of US paper: " + us_paper.size())
        #print("Size of HK paper: " + hk_paper.size())
        #print("Size of JP paper: " + jp_paper.size())
